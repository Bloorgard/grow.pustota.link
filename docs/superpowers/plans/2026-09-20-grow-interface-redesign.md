...
> **Этот план отработан и закрыт. Читать его не нужно.**
>
> Все восемь задач выполнены, их шаги уже в коде, ветка влита в `master`
> 2026-09-20. Документ сохранён как история: по нему видно, в каком порядке
> собиралась переделка и какими проверками закрывался каждый шаг.
>
> Принятые решения и причины — в `docs/superpowers/specs/2026-09-20-grow-interface-redesign-design.md`.
> Что нужно знать для работы с кодом — в `AGENTS.md` в корне проекта.
